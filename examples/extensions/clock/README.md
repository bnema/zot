# clock — example zut extension (Node, no dependencies)
...
This copies the manifest + script into `$ZUT_HOME/extensions/clock/`.
zut picks it up the next time you launch the TUI.
...
zut doesn't care which one you use; it just spawns whatever `exec`
