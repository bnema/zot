// clock — a zut extension written in plain Node (no dependencies).
//
...
//
// Install:
//   zut ext install /path/to/this/dir
//
// Then in zut:
//   /now
//   /uptime
...
/**
 * Send a frame to zut. One JSON object per line; flush immediately
...
/**
 * stderr is captured by zut to $ZUT_HOME/logs/ext-clock.log; perfect
...
// 3. Read frames until stdin closes (zut shuts us down).
  ...
  switch (name) {
    ...
    case "uptime": {
      ...
      send({
        ...
        action: "prompt",
        prompt:
          `The clock extension has been running for ${seconds}s in this zut session. ` +
