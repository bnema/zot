...
func TestMCPResultToZut(t *testing.T) {
	if got := mcpResultToZut(nil); len(got.Content) == 0 || got.IsError {
	...
	empty := mcpResultToZut(&mcp.CallToolResult{})
