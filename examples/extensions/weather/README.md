# weather — example zut extension (Go, tool-providing)
...
`$ZUT_HOME/extensions/weather/`. zut picks it up the next time you
...
The tool also shows up in the system prompt's tool list because zut
