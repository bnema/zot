// Tiny Go program that drives `zut rpc` as a subprocess.
//
// For an in-process Go embedding, use github.com/bnema/zut/packages/agent/sdk
...
func main() {
	...
	if tok := os.Getenv("ZUTCORE_RPC_TOKEN"); tok != "" {
